    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-4 px-2">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <Select
            value={String(itemsPerPage)} // Convert itemsPerPage to a string for the Select component
            onValueChange={(value) => onItemsPerPageChange(Number(value))} // Convert the value to a number
          >
